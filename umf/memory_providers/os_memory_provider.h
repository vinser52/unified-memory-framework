...
enum umf_numa_flags { NumaFlagsStrict = 1, NumaFlagsMove, NumaFlagsMoveAll };
#endif

typedef struct umf_os_memory_provider_config_t
    *umf_os_memory_provider_config_handle_t;
...
enum umf_result_t
umfOsMemoryProviderCreate(umf_os_memory_provider_config_handle_t,
                          umf_memory_provider_handle_t *);
void umfOSMemoryProviderDestroy(umf_memory_provider_handle_t);
