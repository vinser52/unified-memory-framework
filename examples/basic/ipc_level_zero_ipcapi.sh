...
# The ipc_level_zero_ipcapi example requires using pidfd_getfd(2)
...
echo "Starting ipc_level_zero_ipcapi CONSUMER on port $PORT ..."
UMF_LOG=$UMF_LOG_VAL ./umf_example_ipc_level_zero_ipcapi_consumer $PORT &

echo "Waiting 1 sec ..."
sleep 1

echo "Starting ipc_level_zero_ipcapi PRODUCER on port $PORT ..."
UMF_LOG=$UMF_LOG_VAL ./umf_example_ipc_level_zero_ipcapi_producer $PORT
